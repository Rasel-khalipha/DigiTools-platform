		...
		<>
			<div>
				<div className="border-2 border-[#f2f2f2] p-10 rounded-2xl space-y-4">
					...
					<button className="w-full bg-linear-to-r from-[#4F39F6] to-[#9514FA] hover:bg-linear-to-r hover:from-[#9514FA] hover:to-[#4F39F6] transition duration-500 rounded-full py-3.75 cursor-pointer text-white font-bold text-base text-center mt-6">
						Proceed to Checkout
					</button>
				</div>
			</div>
